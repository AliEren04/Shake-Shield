# Shake-Shield
This is the first full stack app I have built when were learning javascript and working with node.js in first times of my programming journey and it is used in earthquake events to ask help in a earthquake situation and provide help to people facing or faced earthquakes and see earthquakes happened around world in last 30days!
